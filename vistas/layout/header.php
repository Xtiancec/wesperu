...
<meta charset="utf-8">
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../app/template//images/faviconwes.png"><title>WES PERU</title>


    <link rel="icon" type="image/x-icon" href="../app/template/img/logo.png"/>
    ...
    <link href="../app/template/plugins/sweetalert/sweetalert.css" rel="stylesheet" type="text/css">

  <!-- You can change the theme colors from here -->
    <link href="../app/template/css/colors/default-dark.css" id="theme" rel="stylesheet">

    <link href="../app/template/plugins/select2/dist/css/select2.min.css" rel="stylesheet" type="text/css" />
    <link href="../app/template/plugins/switchery/dist/switchery.min.css" rel="stylesheet" />
    <link href="../app/template/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" />
    ...
    <link href="../app/template/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css" />
...
<body class="fix-header card-no-border fix-sidebar">
     ...
     <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label"> WES PERU</p>
        </div>
    </div>
