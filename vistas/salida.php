                                        ...
                                        <form action="" name="formulario" id="formulario" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-3 col-md-3 col-xs-3">
                                                    ...
                                                    <input class="form-control" type="date" id="fecha" nombre="fecha" placeholder="fecha" required>
                                                </div>
                                                <div class="form-group col-lg-3 col-md-3 col-xs-3">
                                                ...
                                                <div class="form-group col-lg-3 col-md-3 col-xs-3">
                                                    ...
                                                    <input class="form-control" type="number" id="costoUnitario" nombre="costoUnitario" min="0" step="0.01" placeholder="S/0.00">
                                                </div>
                                                <div class="form-group col-lg-3 col-md-3 col-xs-3">
