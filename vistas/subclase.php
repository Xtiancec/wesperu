...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Gestionar SubClases</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
            <li class="breadcrumb-item">Configuracion</li>
            <li class="breadcrumb-item active">SubClases</li>
        </ol>
    </div>
    <div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Agregar la Sub Clase</h5>
                                        ...
                                        <form action="" name="formulario" id="formulario" method="POST">
                                            <div class="row">
                                                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                                    ...
                                                    <select id="idClase" class="select2 form-control custom-select"  style="width:100%; height:100%;">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                                    ...
                                                    <input class="form-control" type="hidden" id="idSubclase" nombre="idSubclase">
                                                    <input class="form-control" type="text" id="nombre" nombre="nombre" maxlength="50" placeholder="Nombre de la subclase" required>
                                                </div>
                                            </div>
...
?>
<script src="scripts/subclase.js">
</script>
<?php
?>