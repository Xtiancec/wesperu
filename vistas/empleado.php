                                            ...
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="border-profile-tab">
                                                <div class="row no-outer-spacing">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4">
                                                        ...
                                                        <input class="form-control" type="number" id="numeroDocumento" nombre="numeroDocumento" maxlength="20" placeholder="Numero de Documento" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-3 col-md-3 col-xs-3">
                                                        ...
                                                        <input class="form-control" type="text" id="apellidoPaterno" nombre="apellidoPaterno" maxlength="20" placeholder="Apellido Paterno" required>
                                                    </div>


                                                    <div class="form-group col-lg-3 col-md-3 col-xs-3">
                                                        <label for="">Apellido Materno</label>
                                                        <input class="form-control" type="text" id="apellidoMaterno" nombre="apellidoMaterno" maxlength="50" placeholder="Apellido Materno" required>
                                                    </div>

                                                    <div class="form-group col-lg-6 col-md-6 col-xs-6">
                                                        <label for="">Nombres</label>
                                                        <input class="form-control" type="text" id="nombre" nombre="nombre" maxlength="50" placeholder="Nombres" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4">
                                                        ...
                                                        <input class="form-control" type="number" id="telefono" nombre="telefono" maxlength="50" placeholder="numero de telefono" required>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4">
                                                        <label for="telefono">Persona Contacto</label>
                                                        <input class="form-control" type="text" id="personaContacto" nombre="personaContacto" maxlength="50" placeholder="familiar del contacto" required>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4">
                                                        <label for="telefono">Telefono Emergencia</label>
                                                        <input class="form-control" type="text" id="telefonoEmergencia" nombre="telefonoEmergencia" maxlength="50" placeholder="telefono del familiar" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="border-profile-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-lg-8 col-md-8 col-xs-8">
                                                        ...
                                                        <input class="form-control" type="number" id="numeroCuenta" nombre="numeroCuenta" maxlength="50" placeholder="numero Cuenta" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-lg-4 col-md-4 col-xs-4">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-5 col-md-5 col-xs-5">
                                                        ...
                                                        <select id="distrito" class="form-control" >
                                                            ...
                                                            <option value="PRUENTE PIEDRA">PRUENTE PIEDRA</option>
