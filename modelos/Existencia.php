...
public function insertar($idSubclase,$idUM,$nombre,$stockInicial,$precioActual){
	$sql="INSERT INTO existencia (idSubclase,idUM,nombre,stockActual,stockInicial,precioActual,precioPromedio,estado)
	 VALUES ('$idSubclase','$idUM','$nombre','$stockInicial','$stockInicial','$precioActual','$precioActual','1')";
	return ejecutarConsulta($sql);
}

public function editar($idExistencia,$idSubclase,$idUM,$nombre){
	$sql="UPDATE existencia SET idSubclase='$idSubclase', idUM='$idUM',nombre='$nombre'
