...
$stockInicial = isset($_POST["stockInicial"]) ? limpiarCadena($_POST["stockInicial"]) : "";
$precioActual = isset($_POST["precioActual"]) ? limpiarCadena($_POST["precioActual"]) : "";

switch ($_GET["op"]) {

    case 'guardar':
        $rspta = $existencia->insertar($idSubclase, $idUM, $nombre, $stockInicial, $precioActual);
        echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
        break;

    case 'editar':
        $rspta = $existencia->editar($idExistencia, $idSubclase, $idUM, $nombre);
